            ...
            public void onClick(View view) {
                ...
                if(!txtNombre.getText().toString().equals("") && !txtTelefono.getText().toString().equals("")) {
                    ...
                    if (id > 0) {
                        ...
                        Toast.makeText(NuevoActivity.this, "Error, no se pudo completar el registro", Toast.LENGTH_LONG).show();
                    }
                } else {
                    Toast.makeText(NuevoActivity.this, "Por favor complete todos los campos", Toast.LENGTH_LONG).show();
                }
            }
        });
    }
